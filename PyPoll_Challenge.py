...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (cvotes > votes_turnout) and (cvotes_percentage > turnout_percentage):
            options_turnout = county_name
            votes_turnout = cvotes
            turnout_percentage = cvotes_percentage
    # 7: Print the county with the largest turnout to the terminal.
    largest_turnout_summary = (
        f"-------------------------\n"
        f"Largest County Turnout: {options_turnout}\n"
        f"-------------------------\n")
